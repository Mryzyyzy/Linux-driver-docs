#!/bin/bash
#
# 静态编译 kexec-tools（用于 BusyBox 环境）
#

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
BUILD_DIR="$SCRIPT_DIR/../experiments/kexec-tools-build"
INSTALL_DIR="$SCRIPT_DIR/../experiments/kexec-tools-install"

CROSS_COMPILE=${CROSS_COMPILE:-aarch64-linux-gnu-}

echo "=========================================="
echo "  静态编译 kexec-tools"
echo "=========================================="
